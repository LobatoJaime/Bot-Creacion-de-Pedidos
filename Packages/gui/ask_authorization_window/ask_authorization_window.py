...
from Packages.gui.ask_authorization_window.ask_authorization_table import AskAuthorizationTable
...
class AskAuthorizationWindow:
    ...
    def __init__(self, root: tk.Tk, gui):
        ...
        self.create_order_table = AskAuthorizationTable(self.window_frame,
        ...
        self.version_text = ttk.Label(self.window_frame, text="Solicitud de Aprobacion", font=("Arial", 20))
        self.version_text.place(rely=0.05, relx=0.72, relwidth=0.25)

        # Cuadro de ajustes
        self.settings_label_frame = ttk.Labelframe(self.window_frame, text='Ajustes')
        self.settings_label_frame.place(rely=0.1, relx=0.72, relwidth=0.25)
