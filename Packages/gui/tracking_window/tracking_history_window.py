...
from .tracking_history_table import TrackingHistoryTable


class TrackingHistoryWindow:
    def __init__(self, root: tk.Tk, gui):
        ...
        self.history_changes_table = TrackingHistoryTable(self.window_frame)
        self.history_changes_table.list_frame.place(rely=0.05, relx=0, relheight=0.92, relwidth=.8)
