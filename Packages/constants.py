...
planes_entrega_folder = os.path.join(resources_folder, 'planes_entrega')
planes_entrega_approve_folder = os.path.join(resources_folder, 'planes_entrega_approve')
...
token_github1 = 'ghp_peAIq1gUV4PY'
token_github2 = 'NsuuCd6T6za2MGTvUN0xetcH'
