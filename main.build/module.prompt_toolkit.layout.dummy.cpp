...
static PyCodeObject *codeobj_762bec1de1424f2b813ef0342daa5c8f;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_762bec1de1424f2b813ef0342daa5c8f = MAKE_CODEOBJECT(module_filename_obj, 28, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[6], mod_consts[52], NULL, 1, 0, 0);
}
...
static PyObject *impl_prompt_toolkit$layout$dummy$$$function__1_create_dummy_layout$$$function__1_enter(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_762bec1de1424f2b813ef0342daa5c8f;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    ...
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_762bec1de1424f2b813ef0342daa5c8f = NULL;
    PyObject *tmp_return_value = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_762bec1de1424f2b813ef0342daa5c8f)) {
        Py_XDECREF(cache_frame_762bec1de1424f2b813ef0342daa5c8f);

#if _DEBUG_REFCOUNTS
        if (cache_frame_762bec1de1424f2b813ef0342daa5c8f == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_762bec1de1424f2b813ef0342daa5c8f = MAKE_FUNCTION_FRAME(codeobj_762bec1de1424f2b813ef0342daa5c8f, module_prompt_toolkit$layout$dummy, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_762bec1de1424f2b813ef0342daa5c8f->m_type_description == NULL);
    frame_762bec1de1424f2b813ef0342daa5c8f = cache_frame_762bec1de1424f2b813ef0342daa5c8f;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_762bec1de1424f2b813ef0342daa5c8f);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_762bec1de1424f2b813ef0342daa5c8f) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        frame_762bec1de1424f2b813ef0342daa5c8f->m_frame.f_lineno = 30;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_762bec1de1424f2b813ef0342daa5c8f);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_762bec1de1424f2b813ef0342daa5c8f, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_762bec1de1424f2b813ef0342daa5c8f->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_762bec1de1424f2b813ef0342daa5c8f, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_762bec1de1424f2b813ef0342daa5c8f,
        type_description_1,
        par_event
    );
    ...
    // Release cached frame if used for exception.
    if (frame_762bec1de1424f2b813ef0342daa5c8f == cache_frame_762bec1de1424f2b813ef0342daa5c8f) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_762bec1de1424f2b813ef0342daa5c8f);
        cache_frame_762bec1de1424f2b813ef0342daa5c8f = NULL;
    }

    assertFrameObject(frame_762bec1de1424f2b813ef0342daa5c8f);
...
static PyObject *MAKE_FUNCTION_prompt_toolkit$layout$dummy$$$function__1_create_dummy_layout$$$function__1_enter(PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[7],
#endif
        codeobj_762bec1de1424f2b813ef0342daa5c8f,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
