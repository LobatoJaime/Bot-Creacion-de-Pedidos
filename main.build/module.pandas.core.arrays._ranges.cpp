...
static PyObject *impl_pandas$core$arrays$_ranges$$$function__2__generate_range_overflow_safe(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
        ...
        tmp_left_value_1 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_1, mod_consts[29], tmp_args_element_value_2);
        if (tmp_left_value_1 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_yes_9:;
    {
        ...
        tmp_args_element_value_15 = BINARY_OPERATION_SUB_OBJECT_OBJECT_OBJECT(tmp_left_value_3, tmp_right_value_3);
        ...
        tmp_args_element_value_16 = BINARY_OPERATION_SUB_OBJECT_OBJECT_LONG(tmp_left_value_4, tmp_right_value_4);
...
static PyObject *impl_pandas$core$arrays$_ranges$$$function__3__generate_range_overflow_safe_signed(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_7:;
    {
        ...
        tmp_right_value_5 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_6, mod_consts[29], tmp_args_element_value_7);
        if (tmp_right_value_5 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        tmp_cmp_expr_right_11 = BINARY_OPERATION_ADD_OBJECT_OBJECT_OBJECT(tmp_left_value_5, tmp_right_value_5);
        Py_DECREF(tmp_right_value_5);
