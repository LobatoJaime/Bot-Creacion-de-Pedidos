...
static PyObject *impl_dateutil$zoneinfo$$$function__3___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
        ...
        branch_yes_2:;
        {
            ...
            tmp_kw_call_dict_value_0_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_5, mod_consts[19]);
            ...
            frame_01ad3de74a44e694085b646f678d37b7_2->m_frame.f_lineno = 34;
            {
                ...
                tmp_dictset_value = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(tmp_called_value_3, args, kw_values, mod_consts[24]);
            }
            ...
            tmp_dictset_key = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[19]);
    ...
    }
    {
        ...
        branch_yes_3:;
        {
            ...
            tmp_subscript_value_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_9, mod_consts[29]);
            ...
            tmp_dictset_key = LOOKUP_ATTRIBUTE(tmp_expression_value_10, mod_consts[19]);
            if (tmp_dictset_key == NULL) {
                assert(ERROR_OCCURRED());
