...
static PyObject *impl_pandas$core$window$numba_$$$function__2_generate_numba_ewma_func$$$function__2_ewma(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_2:;
    {
        ...
        tmp_left_value_6 = var_old_wt_factor;
        if (Nuitka_Cell_GET(self->m_closure[2]) == NULL) {
        ...
        tmp_subscript_value_6 = BINARY_OPERATION_SUB_OBJECT_OBJECT_LONG(tmp_left_value_7, tmp_right_value_8);
    ...
    branch_yes_4:;
    {
        ...
        tmp_right_value_9 = var_weighted_avg;
        ...
        tmp_left_value_12 = var_new_wt;
        CHECK_OBJECT(var_cur);
        tmp_right_value_11 = var_cur;
        ...
        tmp_assign_source_22 = BINARY_OPERATION_TRUEDIV_OBJECT_OBJECT_OBJECT(tmp_left_value_9, tmp_right_value_12);
        Py_DECREF(tmp_left_value_9);
...
static PyObject *impl_pandas$core$window$numba_$$$function__3_generate_numba_table_func$$$function__1_roll_table(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1};
            tmp_assign_source_10 = impl___main__$$$function__8_complex_call_helper_pos_star_list(dir_call_args);
        }
        if (tmp_assign_source_10 == NULL) {
            assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict_pandas$core$window$numba_, (Nuitka_StringObject *)mod_consts[64], tmp_assign_source_4);
    }
    {
        PyObject *tmp_assign_source_5;
